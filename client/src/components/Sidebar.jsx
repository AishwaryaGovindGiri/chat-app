        ...
        <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll
            ...
            <div className="flex flex-col">
                ...
                <div
                    ...
                    className={`flex items-center gap-2 p-2 pl-4 rounded
                        cursor-pointer mb-2 ${
                            isAISelected ? 'bg-violet-500/20' : ''
                        }`}
                >

                    <div className="w-[35px] h-[35px] rounded-full bg-violet-500
                ...
                {filteredUsers.map((user, index) => (
                    ...
                    >
                        ...
                        <img
                            src={user?.profile_pic || assets.avatar_icon}
                            alt=""
